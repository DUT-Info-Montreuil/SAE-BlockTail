...
public class JoueurVue extends ImageView {
    ...
    private Image personnageSaut = new Image(getClass().getResource("/universite_paris8/iut/dfang/sae_dev/immobile.png").toExternalForm());
    private Image personnageImmobile = new Image(getClass().getResource("/universite_paris8/iut/dfang/sae_dev/immobile.png").toExternalForm());
