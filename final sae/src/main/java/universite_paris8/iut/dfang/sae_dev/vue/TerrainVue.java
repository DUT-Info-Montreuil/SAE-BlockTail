...
public class TerrainVue {
    ...
    public void createTerrain(){
        ...
        Image ciel = new Image(getClass().getResource("/universite_paris8/iut/dfang/sae_dev/ciel1.png").toExternalForm());
        Image herbe = new Image(getClass().getResource("/universite_paris8/iut/dfang/sae_dev/herbe2terre.jpg").toExternalForm());
        Image terre = new Image(getClass().getResource("/universite_paris8/iut/dfang/sae_dev/bloc2terre.png").toExternalForm());
        Image feuille = new Image(getClass().getResource("/universite_paris8/iut/dfang/sae_dev/arbre.jpg").toExternalForm());
