 ...
 * ---------------------
 * Gère l'affichage du menu de démarrage dans le jeu "BlockTail".
...
public class MenuDemarrage {
    ...
    public void afficherMenuDemarrage(Pane pane, Runnable actionDemarrerJeu) {
        ...
        // Image de fond du menu (penser à adapter le chemin vers ton image)
        Image menuImage = new Image(getClass().getResourceAsStream("/blocktail/images/menu.png"));
        ...
        startButton.setLayoutX(765);          // Position X (adapter selon ta fenêtre)
        startButton.setLayoutY(725);          // Position Y (adapter selon ta fenêtre)
